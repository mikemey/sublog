...
class ModelMarkdownTests(SublogTestCase):
    def setUp(self):
        self.input = self.test_file_content('full_markdown_input.md')
        self.expected = self.test_file_content('full_markdown_expected.html')
    ...
    def test_article_markdown(self):
        ...
        self.compare_contents(self, self.expected, actual)
